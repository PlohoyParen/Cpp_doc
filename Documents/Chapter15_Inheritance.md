...
**Вывод: никогда не использовать передачу по значению для классов, а также не присваивать объект дочернего классов объекту родительского**. Это не полиморфично!  
