...
1. ```cpp
    ...
    public:
     ...
     ```
2. ```cpp
    // 2. Случай virtual написано у родятеля по которому идет срез
    class A
    {
    public:
    ...
    public:
     ...
     3. Случаий 3, это когда `virtual` указывается для всех ф-ций, задуманных как virtual. Это самый лучший способ, тк улучшает читаемость кода. 
