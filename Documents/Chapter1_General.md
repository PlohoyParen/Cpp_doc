...
- При выполнении программы C++ память разделяется на 2 сегмента: сегмент глобальных данных и стек. Также можно потребовать от системы выделить динамическую память под нужды программы.
