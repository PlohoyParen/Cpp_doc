...
Тут пример как с помощью списка инициализировать массив и константу:
```cpp
class Values
{
private:
...
public:
    Values(): m_value(7), 	/* напрямую инициализируем константную переменную-член
    			   	(а можно так:) Values(): m_value { 7 } // используем uniform инициализацию */
              m_array { 3, 4, 5, 6, 7, 8, 9 } 	/* используем uniform инициализацию для инициализации массива.
	      				        А так обнуляем массив m_array {}  */
    {
    } 
};
```
