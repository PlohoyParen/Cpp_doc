...
Память на видеокарте можно отнести к двум типам (по их расположению): 1) основную (DRAM) и 2) отдельную на каждом мультипроцессоре (SM-streaming multiprocessor).
